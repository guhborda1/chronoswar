...
export const warEvents: WarEvent[] = [
  {
      ...
      sides: [
        {
          ...
          slogans: [
            "Reivindicação ao Trono Francês",
            "Defensores do solo inglês",
          ],
      ...
      financiers: [
        {
          ...
          type: "government",
          amount:
            "Financiamento por meio de impostos e exploração de territórios",
          assets: "Tesouro Real",
          religion: "Católica",
    ...
    masons: [
      {
        name: "William de Wykeham",
        affiliation: "Guild of Masons, Inglaterra",
        religion: "Cristão (Católico)",
        position: "Mestre de Obras da Catedral de Winchester",
        country: "Inglaterra",
        activeYears: { fromYear: 1350, toYear: 1404 },
      },
      {
        name: "Henry Yevele",
        affiliation: "Guild of Masons, Londres",
        religion: "Cristão (Católico)",
        position: "Mestre de Obras Reais",
        country: "Inglaterra",
        activeYears: { fromYear: 1350, toYear: 1400 },
      },
      {
        name: "Jean d'Orbais",
        affiliation: "Mestre construtor da Catedral de Reims",
        religion: "Cristão (Católico)",
        position: "Arquitecto-chefe",
        country: "França",
        activeYears: { fromYear: 1310, toYear: 1337 },
      },
      {
        name: "Michael of Canterbury",
        affiliation: "Guild of Masons",
        religion: "Cristão (Católico)",
        position: "Arquiteto da Catedral de Canterbury",
        country: "Inglaterra",
        activeYears: { fromYear: 1320, toYear: 1350 },
      },
      {
        name: "Villard de Honnecourt",
        affiliation: "Ofício de construtores franceses",
        religion: "Cristão (Católico)",
        position: "Desenhista e engenheiro",
        country: "França",
        activeYears: { fromYear: 1225, toYear: 1330 },
      },
    ],
  },
  {
    ...
    masons: [
      {
        ...
        affiliation: "Guild of Masons, Inglaterra",
        religion: "Cristão (Católico)",
        position: "Mestre de Obras na Catedral de Ely",
        country: "Inglaterra",
        activeYears: { fromYear: 1440, toYear: 1460 },
      },
      {
        name: "John of Gaunt",
        affiliation: "Guild of Masons, Inglaterra",
        religion: "Cristão (Católico)",
        position: "Patrono e apoiador de grandes projetos de construção",
        country: "Inglaterra",
        activeYears: { fromYear: 1420, toYear: 1460 },
      },
      {
        name: "Guillaume de l'Oise",
        affiliation: "Guilda de Construtores, França",
        religion: "Cristão (Católico)",
        position: "Mestre construtor na Catedral de Beauvais",
        country: "França",
        activeYears: { fromYear: 1440, toYear: 1465 },
      },
      {
        name: "Henry Yevele",
        affiliation: "Guild of Masons, Inglaterra",
        religion: "Cristão (Católico)",
        position: "Mestre de Obras Reais, Arquiteto",
        country: "Inglaterra",
        activeYears: { fromYear: 1350, toYear: 1460 },
      },
      {
        name: "André Godin",
        affiliation: "Guilda de Masons de Paris",
        religion: "Cristão (Católico)",
        position: "Mestre construtor, responsável por várias catedrais",
        country: "França",
        activeYears: { fromYear: 1430, toYear: 1465 },
      },
      {
        name: "Richard de Waltham",
        affiliation: "Guild of Masons, Inglaterra",
        religion: "Cristão (Católico)",
        position: "Mestre construtor",
        country: "Inglaterra",
        activeYears: { fromYear: 1430, toYear: 1455 },
      },
    ],
  },
  {
    ...
    masons: [
      {
        ...
        affiliation: "Guilda de Masons, Florença",
        religion: "Cristão (Católico)",
        position: "Mestre de Obras, Arquiteto",
        country: "Itália",
        activeYears: { fromYear: 1401, toYear: 1446 },
      },
      {
        name: "Donato Bramante",
        affiliation: "Guilda de Masons, Roma",
        religion: "Cristão (Católico)",
        position: "Mestre de Obras, Arquiteto",
        country: "Itália",
        activeYears: { fromYear: 1470, toYear: 1514 },
      },
      {
        name: "Giorgio Vasari",
        affiliation: "Guilda de Masons, Florença",
        religion: "Cristão (Católico)",
        position: "Mestre de Obras, Pintor e Arquiteto",
        country: "Itália",
        activeYears: { fromYear: 1520, toYear: 1574 },
      },
      {
        name: "Andrea Palladio",
        affiliation: "Guilda de Masons, Veneza",
        religion: "Cristão (Católico)",
        position: "Arquiteto e Designer",
        country: "Itália",
        activeYears: { fromYear: 1540, toYear: 1580 },
      },
      {
        name: "Matthias Grünewald",
        affiliation: "Guilda de Masons, Alemanha",
        religion: "Cristão (Católico)",
        position: "Mestre de Obras, Pintor e Construtor",
        country: "Alemanha",
        activeYears: { fromYear: 1480, toYear: 1528 },
      },
      {
        name: "Hans Holbein, o Jovem",
        affiliation: "Guilda de Masons, Basileia",
        religion: "Cristão (Católico)",
        position: "Mestre de Obras, Pintor e Designer",
        country: "Suíça",
        activeYears: { fromYear: 1515, toYear: 1543 },
      },
      {
        name: "Sebastiano Serlio",
        affiliation: "Guilda de Masons, Roma",
        religion: "Cristão (Católico)",
        position: "Arquiteto e Teórico",
        country: "Itália",
        activeYears: { fromYear: 1530, toYear: 1554 },
      },
      {
        name: "Giovanni Antonio Amadeo",
        affiliation: "Guilda de Masons, Milão",
        religion: "Cristão (Católico)",
        position: "Mestre de Obras",
        country: "Itália",
        activeYears: { fromYear: 1470, toYear: 1515 },
      },
    ],
  },
  {
...

  {
    ...
    propaganda: {
      sides: [
        ...
        },
        {
          ...
          mediaOutlets: ["The London Gazette"],
          techniques: [
      ...
      analysis:
        "A propaganda de ambos os lados enfatizava a legitimidade e o equilíbrio de poder, ocultando interesses econômicos e coloniais.",
    },
    theories: [
      {
        title: "Equilíbrio de Poder",
        description:
          "As potências europeias entraram em guerra para evitar que a França se tornasse demasiado poderosa.",
        evidence: "Alianças formadas e tratados diplomáticos da época.",
      },
      {
        title: "Motivações Comerciais",
        description:
          "Interesses comerciais nas Américas foram a verdadeira motivação por trás do conflito.",
    ...
    relatedNews: [
      {
        ...
        description:
          "O tratado de 1713 encerra a guerra e redistribui territórios na América e Europa.",
    ...
    financialInfo: {
      financialImpact:
        "The war had significant economic consequences for all parties involved",
      banks: [
        {
      ...
      sides: [
        {
          ...
          slogans: ["Defesa da liberdade", "Contra o absolutismo francês"],
          mediaOutlets: ["The London Chronicle"],
          techniques: [
  ...
  },
  {
      ...
      sides: [
        {
          ...
          slogans: ["No taxation without representation", "Liberdade ou morte"],
          mediaOutlets: ["Pennsylvania Gazette"],
          techniques: ["Apelo à liberdade", "Demonização do rei britânico"],
        },
        {
          name: "Império Britânico",
          slogans: ["Unidade do Império", "Ordem e lei"],
          mediaOutlets: ["The London Gazette"],
          techniques: ["Deslegitimação dos rebeldes", "Apelo à tradição"],
        },
      ],
      analysis:
        "A propaganda revolucionária americana foi fundamental para mobilizar apoio popular, enquanto a britânica buscava manter a ordem imperial.",
    },
    theories: [
      {
    ...
    relatedNews: [
      {
        ...
        description:
          "Diversos líderes revolucionários morreram em circunstâncias suspeitas nos anos seguintes à independência americana",
      ...
      },
      {
        ...
        description:
          "Novos documentos históricos mostram ligações financeiras entre líderes revolucionários e instituições bancárias europeias",
      ...
      },
      {
        ...
        description:
          "Documentos históricos revelam a extensa influência maçônica na estruturação do governo dos Estados Unidos",
        source: "Arquivos Históricos Nacionais",
        date: "1776",
      },
      {
    ...
    masons: [
      {
        name: "George Washington",
        affiliation: "Fredericksburg Lodge No. 4, Virginia",
        religion: "Anglicano",
      ...
      },
      {
        ...
        affiliation:
          "Loge des Neuf Sœurs, Paris / St. John's Lodge, Philadelphia",
        religion: "Deísta",
        position: "Past Grand Master (Provincial)",
        country: "Estados Unidos / França",
        activeYears: { fromYear: 1731, toYear: 1790 },
      },
      {
        name: "Voltaire",
        affiliation: "Loge des Neuf Sœurs, Paris",
        religion: "Deísta",
        position: "Membro Iniciado",
        country: "França",
        activeYears: { fromYear: 1778, toYear: 1778 },
      },
      {
        name: "Marquês de Lafayette",
        affiliation: "Loge Contrat Social, Paris",
        religion: "Católico",
        position: "Mestre Maçom",
        country: "França",
        activeYears: { fromYear: 1775, toYear: 1834 },
      },
      {
        name: "Frederico II da Prússia (Frederico, o Grande)",
        affiliation: "Loja Nacional dos Três Globos, Berlim",
        religion: "Protestante (Reformado)",
        position: "Protetor da Maçonaria Prussiana",
        country: "Prússia",
        activeYears: { fromYear: 1740, toYear: 1786 },
      },
      {
        name: "José Bonifácio de Andrada e Silva",
        affiliation: "Loja Maçônica Comércio e Artes, Lisboa",
        religion: "Católico",
        position: "Membro Iniciado",
        country: "Brasil / Portugal",
        activeYears: { fromYear: 1790, toYear: 1838 },
      },
      {
        name: "Jean-Baptiste Willermoz",
        affiliation: "Grande Loja Regular dos Mestres, Lyon",
        religion: "Católico",
        position: "Grão-Mestre",
        country: "França",
        activeYears: { fromYear: 1750, toYear: 1824 },
      },
      {
        name: "Joseph Warren",
        affiliation: "Lodge St. Andrew No. 81, Boston",
        religion: "Cristão",
        position: "Grão-Mestre Provincial da Maçonaria Escocesa na América",
        country: "Estados Unidos",
        activeYears: { fromYear: 1769, toYear: 1775 },
      },
      {
        name: "John Paul Jones",
        affiliation: "St. Bernard’s Kilwinning Lodge No. 122, Kirkcudbright",
        religion: "Presbiteriano",
        position: "Mestre Maçom",
        country: "Escócia / Estados Unidos",
        activeYears: { fromYear: 1770, toYear: 1792 },
      },
      {
        name: "Philip Syng",
        affiliation: "St. John's Lodge, Filadélfia",
        religion: "Anglicano",
        position: "Grão-Mestre da Grande Loja da Pensilvânia",
        country: "Estados Unidos",
        activeYears: { fromYear: 1741, toYear: 1789 },
      },
      {
        name: "Bartholomew Ruspini",
        affiliation: "Lodge of the Nine Muses, Londres",
        religion: "Anglicano (convertido do Catolicismo)",
        position: "Membro Fundador",
        country: "Reino Unido",
        activeYears: { fromYear: 1768, toYear: 1813 },
      },
      {
        name: "George Walton",
        affiliation: "Solomon’s Lodge No. 1, Savannah, Geórgia",
        religion: "Anglicano",
        position: "Membro Iniciado",
        country: "Estados Unidos",
        activeYears: { fromYear: 1775, toYear: 1804 },
      },
      {
        name: "David Wooster",
        affiliation: "Hiram Lodge No. 1, Connecticut",
        religion: "Congregacionalista",
        position: "Mestre Maçom",
        country: "Estados Unidos",
        activeYears: { fromYear: 1750, toYear: 1777 },
      },
      {
        name: "William Byron, 5º Barão Byron",
        affiliation: "Premier Grand Lodge of England",
        religion: "Anglicano",
        position: "Grão-Mestre",
        country: "Reino Unido",
        activeYears: { fromYear: 1747, toYear: 1751 },
      },
      {
        name: "Cadwallader Blayney, 9º Barão Blayney",
        affiliation: "Premier Grand Lodge of England",
        religion: "Anglicano",
        position: "Grão-Mestre",
        country: "Irlanda / Reino Unido",
        activeYears: { fromYear: 1764, toYear: 1767 },
      },
      {
        name: "John Hancock",
        affiliation: "St. Andrew’s Lodge, Boston",
        religion: "Congregacionalista",
        position: "Mestre Maçom",
        country: "Estados Unidos",
        activeYears: { fromYear: 1760, toYear: 1793 },
      },
      {
        name: "Elbridge Gerry",
        affiliation: "Philanthropic Lodge, Marblehead, Massachusetts",
        religion: "Congregacionalista",
        position: "Membro Iniciado",
        country: "Estados Unidos",
        activeYears: { fromYear: 1770, toYear: 1814 },
      },
      {
        name: "William Hooper",
        affiliation: "Hanover Lodge, Masonborough, Carolina do Norte",
        religion: "Anglicano",
        position: "Membro Iniciado",
        country: "Estados Unidos",
        activeYears: { fromYear: 1770, toYear: 1790 },
      },
      {
        name: "Richard Stockton",
        affiliation: "St. John’s Lodge, Princeton, Nova Jersey",
        religion: "Presbiteriano",
        position: "Mestre Fundador",
        country: "Estados Unidos",
        activeYears: { fromYear: 1760, toYear: 1781 },
      },
      {
        name: "Matthew Thornton",
        affiliation: "Loja Militar Britânica (Louisbourg)",
        religion: "Presbiteriano",
        position: "Membro Iniciado",
        country: "Estados Unidos",
        activeYears: { fromYear: 1745, toYear: 1803 },
      },
      {
        name: "William Whipple",
        affiliation: "St. John’s Lodge, Portsmouth, New Hampshire",
        religion: "Congregacionalista",
        position: "Membro Iniciado",
        country: "Estados Unidos",
        activeYears: { fromYear: 1770, toYear: 1785 },
      },
      {
        name: "Joseph Hewes",
        affiliation: "St. James’s Lodge No. 3, Wilmington, Carolina do Norte",
        religion: "Quaker",
        position: "Membro Iniciado",
        country: "Estados Unidos",
        activeYears: { fromYear: 1770, toYear: 1779 },
      },
      {
        name: "Robert Morris",
        affiliation: "Tun Tavern Lodge No. 30, Filadélfia",
        religion: "Episcopal",
        position: "Membro Iniciado",
        country: "Estados Unidos",
        activeYears: { fromYear: 1770, toYear: 1806 },
      },
      {
        name: "James Monroe",
        affiliation: "Williamsburg Lodge No. 6, Virgínia",
        religion: "Episcopal",
        position: "Aprendiz Iniciado",
        country: "Estados Unidos",
        activeYears: { fromYear: 1775, toYear: 1831 },
      },
      // {
      //   name: "Mark Twain",
  ...
  },
  {
    ...
    masons: [
      ...
      },
      {
        ...
        affiliation: "Loja Philadelphe do Exército, Malta (possível)",
        religion: "Católico",
        position: "Simpatizante e patrono da maçonaria",
        country: "França",
        activeYears: { fromYear: 1795, toYear: 1821 },
      },
      {
        name: "Joseph Bonaparte",
        affiliation: "Grande Oriente da França",
        religion: "Católico",
        position: "Grão-Mestre",
        country: "França",
        activeYears: { fromYear: 1805, toYear: 1814 },
      },
      {
        name: "Louis Bonaparte",
        affiliation: "Grande Oriente da França",
        religion: "Católico",
        position: "Grão-Mestre Adjunto",
        country: "França",
        activeYears: { fromYear: 1804, toYear: 1810 },
      },
      {
        ...
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1795, toYear: 1804 },
      },
      {
        name: "Jean-Jacques Régis de Cambacérès",
        affiliation: "Grande Oriente da França",
        religion: "Católico",
        position: "Grão-Chanceler do Império e Maçom influente",
        country: "França",
        activeYears: { fromYear: 1799, toYear: 1824 },
      },
      {
        name: "André Masséna",
        affiliation: "Loja Les Élèves de Minerve, Toulon",
        religion: "Católico",
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1784, toYear: 1817 },
      },
      {
        name: "Joachim Murat",
        affiliation: "Grande Oriente da França",
        ...
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1800, toYear: 1815 },
      },
      {
        name: "François Joseph Lefebvre",
        affiliation: "Loja Réunion des Amis, Mainz",
        religion: "Católico",
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1790, toYear: 1820 },
      },
      {
        name: "Jean-Baptiste Kléber",
        affiliation: "Loja Isis, Cairo",
        religion: "Católico",
        position: "Fundador",
        country: "França",
        activeYears: { fromYear: 1798, toYear: 1800 },
      },
      {
        name: "Dominique Vivant Denon",
        affiliation: "Loja Les Sophisiens, Paris",
        religion: "Católico",
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1780, toYear: 1825 },
      },
      {
        name: "Gaspard Monge",
        affiliation: "Loja Union Parfaite, Mézières",
        religion: "Católico",
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1780, toYear: 1818 },
      },
      {
        name: "Joseph Jérôme Lefrançois de Lalande",
        affiliation: "Loja Les Neuf Sœurs, Paris",
        religion: "Católico",
        position: "Venerável Mestre",
        country: "França",
        activeYears: { fromYear: 1776, toYear: 1807 },
      },
      {
        name: "Jean-Antoine Chaptal",
        affiliation: "Loja Union Parfaite, Montpellier",
        religion: "Católico",
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1780, toYear: 1832 },
      },
      {
        name: "Joseph Fouché",
        affiliation: "Loja Sophie Madeleine, Rainha da Suécia, Arras",
        religion: "Católico",
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1790, toYear: 1820 },
      ...
      {
        name: "Horace Sébastiani",
        affiliation: "Grande Oriente da França",
        religion: "Católico",
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1800, toYear: 1830 },
      },
      {
        name: "Jean Lannes",
        affiliation: "Grande Oriente da França",
        ...
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1800, toYear: 1809 },
      },
      {
        name: "Étienne Macdonald",
        affiliation: "Grande Oriente da França",
        religion: "Católico",
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1800, toYear: 1825 },
      },
      {
        name: "Guillaume Brune",
        affiliation: "Loja Saint-Napoléon, Paris",
        religion: "Católico",
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1800, toYear: 1815 },
      ...
      {
        name: "Adolphe Édouard Casimir Joseph Mortier",
        affiliation: "Grande Oriente da França",
        religion: "Católico",
        position: "Membro",
        country: "França",
        activeYears: { fromYear: 1800, toYear: 1835 },
      },
      // Estados Unidos
      {
        name: "George Washington",
        affiliation: "Alexandria Lodge No. 22, Virgínia",
        religion: "Cristão (Anglicano)",
        position: "Venerável Mestre",
        country: "Estados Unidos",
        activeYears: { fromYear: 1753, toYear: 1799 },
      },
      {
        name: "Benjamin Franklin",
        affiliation: "St. John's Lodge, Filadélfia; Loge des Neuf Sœurs, Paris",
        religion: "Deísta",
        position: "Grão-Mestre da Pensilvânia",
        country: "Estados Unidos",
        activeYears: { fromYear: 1731, toYear: 1790 },
      },
      {
        name: "Paul Revere",
        affiliation: "St. Andrew's Lodge, Boston",
        religion: "Cristão (Congregacionalista)",
        position: "Grão-Mestre de Massachusetts",
        country: "Estados Unidos",
        activeYears: { fromYear: 1760, toYear: 1818 },
      },
      {
        name: "Samuel Johnston",
        affiliation: "Grande Loja da Carolina do Norte",
        religion: "Cristão (Anglicano)",
        position: "Grão-Mestre",
        country: "Estados Unidos",
        activeYears: { fromYear: 1787, toYear: 1792 },
      },
      {
        name: "James Mitchell Varnum",
        affiliation: "St. John's Lodge No. 1, Providence, Rhode Island",
        religion: "Cristão (Congregacionalista)",
        position: "Membro",
        country: "Estados Unidos",
        activeYears: { fromYear: 1770, toYear: 1789 },
      },
      {
        name: "Joseph Brant",
        affiliation:
          "Hiram's Cliftonian Lodge No. 47, Barton Lodge No. 6, Hamilton, Ontário",
        religion: "Cristão (Anglicano)",
        position: "Membro",
        country: "Estados Unidos",
        activeYears: { fromYear: 1776, toYear: 1807 },
      ...
      // Alemanha
      {
        ...
        affiliation: "Lodge Amalia, Weimar",
        religion: "Cristão (Luterano)",
        position: "Membro",
        country: "Alemanha",
        activeYears: { fromYear: 1780, toYear: 1832 },
      },
      {
        ...
        affiliation: "Lodge Zu den Drei Goldenen Rosen, Hamburgo",
        religion: "Cristão (Luterano)",
        position: "Membro",
        country: "Alemanha",
        activeYears: { fromYear: 1771, toYear: 1781 },
      },
      {
        name: "Johann Gottfried Herder",
        affiliation: "Lodge Zur Einigkeit, Frankfurt",
        religion: "Cristão (Luterano)",
        position: "Membro",
        country: "Alemanha",
        activeYears: { fromYear: 1780, toYear: 1803 },
      },
      {
        name: "Johann Christian Bode",
        affiliation: "Lodge Absalom, Hamburgo",
        religion: "Cristão (Luterano)",
        position: "Membro",
        country: "Alemanha",
        activeYears: { fromYear: 1770, toYear: 1793 },
      },

      // Suíça
      {
        name: "Jean-Jacques Rousseau",
        affiliation: "Lodge Les Amis Réunis, Genebra",
        religion: "Cristão (Calvinista)",
        position: "Membro",
        country: "Suíça",
        activeYears: { fromYear: 1749, toYear: 1778 },
      },
      {
        name: "Voltaire",
        affiliation: "Loge des Neuf Sœurs, Paris",
      ...
      // Inglaterra
      {
        name: "Thomas Dunckerley",
        affiliation: "Grande Loja Unida da Inglaterra",
        religion: "Cristão (Anglicano)",
        position: "Provincial Grand Master",
        country: "Inglaterra",
        activeYears: { fromYear: 1754, toYear: 1795 },
      },
      {
        name: "William Howley",
        affiliation: "Royal York Lodge, Bristol",
        religion: "Cristão (Anglicano)",
        position: "Venerável Mestre",
        country: "Inglaterra",
        activeYears: { fromYear: 1791, toYear: 1800 },
      },
      {
        name: "Sampson Eardley",
        affiliation: "Provincial Grand Lodge de Cambridgeshire",
        religion: "Cristão (Anglicano)",
        position: "Provincial Grand Master",
        country: "Inglaterra",
        activeYears: { fromYear: 1796, toYear: 1824 },
      },
      {
        name: "John Stuart Mill",
        affiliation: "Provincial Grand Lodge de Gloucestershire",
        religion: "Cristão (Anglicano)",
        position: "Provincial Grand Master",
        country: "Inglaterra",
        activeYears: { fromYear: 1796, toYear: 1824 },
      ...
      sides: [
        {
          ...
          slogans: ["Vive l'Empereur!", "Glória à França"],
          mediaOutlets: ["Le Moniteur Universel"],
          techniques: ["Culto à personalidade", "Exaltação nacionalista"],
        },
        {
          name: "Coalizão Europeia",
          slogans: ["Libertar a Europa de Napoleão", "Pela ordem tradicional"],
          mediaOutlets: ["The Times"],
          techniques: ["Demonização de Napoleão", "Apelo à tradição"],
        },
      ],
      analysis:
        "A propaganda napoleônica construiu uma imagem heroica do imperador, enquanto a coalizão buscava retratá-lo como tirano.",
    },
    theories: [
      {
        title: "Envenenamento de Napoleão",
        description:
          "Napoleão teria sido envenenado em Santa Helena por agentes britânicos.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Conflito entre o Império Russo e uma aliança composta pelo Império Otomano, França, Reino Unido e Sardenha. A guerra teve motivações territoriais, religiosas e políticas, sendo uma das primeiras guerras modernas a envolver cobertura jornalística extensiva.",
    mediaPortrayal:
      "A primeira guerra a ser amplamente fotografada. As imagens de Roger Fenton moldaram a percepção pública, apesar de muitas cenas serem cuidadosamente encenadas. A imprensa britânica teve papel crucial na formação da opinião pública contra a incompetência logística do comando militar.",
    propaganda: {
      sides: [
        {
          name: "Império Russo",
          ...
          mediaOutlets: ["Moskovskie Vedomosti"],
          techniques: [
        ...
        },
        {
          ...
          mediaOutlets: ["The Times", "Le Moniteur Universel"],
          techniques: [
      ...
      analysis:
        "A propaganda foi usada para legitimar o envolvimento das potências europeias, proteger seus interesses no Oriente e mobilizar a opinião pública com base em valores religiosos, civilizatórios e nacionalistas.",
    },
    theories: [
      {
        ...
        evidence:
          "Documentos diplomáticos britânicos e russos revelam preocupações com a influência sobre o Império Otomano e acesso às rotas comerciais para a Índia.",
      },
      {
        ...
        evidence:
          "Registros de conferências de Viena e tratados fracassados indicam múltiplas tentativas de resolução pacífica antes do início do conflito armado.",
      },
      {
        title: "Desvio de foco interno",
        description:
          "A guerra teria servido como distração para problemas internos, especialmente no Império Russo e na França sob Napoleão III.",
        evidence:
    ...
    relatedNews: [
      {
        title:
          "Carga da Brigada Ligeira vira símbolo de bravura e desastre militar",
        description:
          "A desastrosa carga de cavalaria britânica em Balaclava se tornou símbolo da incompetência tática e da coragem soldadesca.",
        source: "The Times",
        date: "1854-10-25",
      },
      {
        ...
        description:
          "O tratado de paz impede a presença russa no Mar Negro e reafirma a integridade territorial do Império Otomano.",
      ...
      },
      {
        ...
        description:
          "A atuação de Florence Nightingale introduz padrões de higiene e tratamento médico moderno nos hospitais de campanha.",
      ...
      },
      {
        ...
        description:
          "Correspondentes de guerra como William Howard Russell influenciaram diretamente o debate político na Inglaterra.",
        source: "The Times",
        date: "1854-1856",
      },
    ],
    financialInfo: {
      financialImpact:
        "A guerra causou forte endividamento nas nações participantes, com altos gastos em logística, transporte e armamentos modernos. A infraestrutura militar moderna elevou os custos de forma inédita.",
      banks: [
        {
          name: "Bank of England",
          country: "England",
          owners: [
            { name: "Lionel de Rothschild", religion: "Jewish" },
            { name: "Baron James de Rothschild", religion: "Jewish" },
          ],
        },
        {
          name: "Banque de France",
          country: "France",
          owners: [
            { name: "Achille Fould", religion: "Jewish" },
            { name: "Napoléon III", religion: "Catholic" },
          ],
        },
        {
          ...
          country: "Russia",
          owners: [
            { name: "Alexander II", religion: "Orthodox" },
            { name: "Ministério das Finanças", religion: "Orthodox" },
          ],
        },
      ],
      financiers: [
...

  {
    ...
    description:
      "Conflito entre os estados do Norte (União) e os estados separatistas do Sul (Confederação), motivado por questões econômicas, políticas e morais, incluindo a escravidão e os direitos dos estados.",
    mediaPortrayal:
      "A guerra é frequentemente retratada como uma luta pela abolição da escravidão, embora também envolvesse interesses econômicos, domínio federal e o papel das elites bancárias e industriais.",
    propaganda: {
      sides: [
        {
          name: "União Americana",
          slogans: ["Preservar a União", "Liberdade para todos"],
          mediaOutlets: ["Harper's Weekly", "The New York Times"],
          techniques: [
        ...
        },
        {
          ...
          slogans: ["Direitos dos Estados", "Nossa terra, nossa escolha"],
          mediaOutlets: ["Richmond Enquirer", "Charleston Mercury"],
          techniques: [
      ...
      analysis:
        "Ambos os lados utilizaram fortemente a imprensa e panfletos para mobilizar apoio popular, moldando a percepção do conflito de acordo com interesses ideológicos e econômicos regionais.",
    },
    theories: [
      {
        title: "A teoria da 'Causa Perdida'",
        description:
          "Narrativa pós-guerra que retrata o Sul como nobre defensor de seus direitos constitucionais, minimizando o papel da escravidão no conflito.",
      },
      {
        title: "Provocação intencional de Lincoln",
        description:
          "Teóricos sugerem que Lincoln provocou o Sul a atacar primeiro em Fort Sumter para justificar a guerra perante o Norte indeciso.",
      },
      {
        title: "Influência dos industriais do Norte",
        description:
          "Alguns historiadores defendem que interesses industriais e financeiros pressionaram pela guerra para consolidar o poder federal sobre a economia.",
      },
      {
        title: "Financiamento internacional estratégico",
        description:
          "Bancos internacionais e grupos financeiros europeus financiaram ambos os lados visando garantir influência econômica na América pós-guerra.",
      },
    ],
    relatedNews: [
      {
        ...
        description:
          "O bombardeio de Fort Sumter pela Confederação provocou a reação militar da União e deu início ao conflito armado.",
      ...
      },
      {
        ...
        description:
          "A Proclamação da Emancipação de Lincoln em 1863 visou enfraquecer o Sul e conquistar apoio internacional à União.",
      ...
      },
      {
        ...
        description:
          "Grandes instituições financeiras do Norte emprestaram bilhões em títulos ao governo da União.",
      ...
      },
      {
        ...
        description:
          "Correspondências da família Rothschild revelam análise estratégica sobre o possível impacto da guerra no comércio internacional.",
    ...
    financialInfo: {
      financialImpact:
        "A Guerra Civil causou grandes desequilíbrios econômicos, inflação no Sul, expansão do sistema bancário no Norte e aumento da dívida pública. Também fortaleceu os bancos do Norte como instituições dominantes na política americana.",
      banks: [
        {
          name: "National City Bank of New York (futura Citibank)",
          country: "USA",
          owners: [
            { name: "Moses Taylor", religion: "Presbiteriano" },
            { name: "George Peabody", religion: "Protestante" },
          ],
        },
        {
          ...
          country: "England",
          owners: [
            { name: "Nathaniel de Rothschild", religion: "Judeu" },
            { name: "Lionel de Rothschild", religion: "Judeu" },
          ],
        },
        {
          name: "Baring Brothers & Co.",
          country: "England",
          owners: [{ name: "Thomas Baring", religion: "Anglicano" }],
        },
        {
          name: "Ernst & Co.",
          country: "Confederate States",
          owners: [{ name: "Charles Prioleau", religion: "Cristão" }],
        },
      ],
      financiers: [
        {
  ...
  },
  {
      ...
      sides: [
        {
          ...
          slogans: ["Preservar a União", "Reconstrução com justiça"],
          mediaOutlets: ["The New York Times", "Harper's Weekly"],
          techniques: [
        ...
        },
        {
          ...
          slogans: ["Vingança pela derrota", "Mártires do Sul"],
          mediaOutlets: ["Richmond Examiner"],
          techniques: ["Culto ao mártir", "Narrativas de revanche"],
        },
      ],
      analysis:
        "A propaganda após o assassinato de Lincoln focou em reforçar sua imagem como mártir nacional, ao mesmo tempo em que ocultava possíveis ligações com interesses econômicos ou conspirações mais amplas.",
    },
    theories: [
      {
        title: "Conspiração bancária internacional",
        description:
          "Teoria sugere envolvimento de banqueiros internacionais devido à oposição de Lincoln ao sistema bancário centralizado e sua emissão dos 'Greenbacks'.",
      },
      {
        title: "Conluio com membros da Confederação",
        description:
          "Evidências apontam para uma conspiração maior envolvendo ex-funcionários e simpatizantes do governo confederado.",
      },
      {
        title: "Nova política monetária ameaçava interesses",
        description:
          "Alguns historiadores argumentam que Lincoln estava prestes a implementar um novo sistema monetário baseado em crédito soberano, o que ameaçava grandes interesses bancários.",
      },
    ],
    relatedNews: [
      {
        ...
        description:
          "Andrew Johnson torna-se presidente, iniciando um período turbulento da Reconstrução.",
      ...
      },
      {
        ...
        description:
          "Vários cúmplices de Booth foram julgados e executados, incluindo Mary Surratt, a primeira mulher executada pelo governo dos EUA.",
      ...
      },
      {
        ...
        description:
          "John Wilkes Booth foi encontrado e morto por tropas da União após doze dias de fuga.",
    ...
    financialInfo: {
      financialImpact:
        "A morte de Lincoln e o subsequente abandono de suas ideias sobre moeda soberana abriram caminho para a restauração da influência de bancos privados no sistema monetário americano.",
      banks: [
        {
  ...
  },
  {
    ...
    description:
      "Conflito entre os Estados Unidos e a Espanha que levou à independência de Cuba e à anexação dos territórios de Porto Rico, Guam e Filipinas pelos EUA, marcando o início do imperialismo americano global.",
    mediaPortrayal:
      "A guerra foi alimentada por uma intensa campanha da 'imprensa amarela' liderada por William Randolph Hearst e Joseph Pulitzer, que publicaram reportagens sensacionalistas sobre abusos espanhóis em Cuba para mobilizar a opinião pública americana.",
    propaganda: {
      sides: [
        {
          name: "Estados Unidos",
          ...
          mediaOutlets: ["New York Journal", "New York World"],
          techniques: [
            "Demonização do inimigo",
            "Apelo emocional",
      ...
      analysis:
        "Nos EUA, a propaganda foi essencial para justificar a guerra como uma missão de libertação, enquanto ocultava os reais interesses imperialistas. Na Espanha, a propaganda focou na defesa da honra nacional e da integridade do império.",
    },
    theories: [
      {
        title: "Explosão deliberada do USS Maine",
        description:
          "Sugere que os próprios Estados Unidos sabotaram o USS Maine no porto de Havana para criar um casus belli e mobilizar a opinião pública a favor da guerra.",
        evidence:
          "Relatórios investigativos contraditórios ao longo das décadas; ausência de provas conclusivas de ataque espanhol; manipulação da imprensa logo após o incidente.",
      },
      {
        title: "Guerra como ferramenta imperialista",
        description:
          "Argumenta-se que a guerra foi deliberadamente provocada como parte de um plano expansionista dos EUA para garantir presença estratégica no Caribe e no Pacífico.",
        evidence:
          "Declarações de políticos da época, como Theodore Roosevelt e Alfred Mahan; rápido controle e anexação dos territórios após a guerra.",
      },
      {
        title: "Poder da imprensa amarela",
        description:
          "Alguns estudiosos acreditam que a imprensa teve papel determinante na deflagração da guerra, moldando a política externa com base em sensacionalismo.",
        evidence:
    ...
    relatedNews: [
      {
        ...
        description:
          "O navio de guerra americano explode em circunstâncias misteriosas, matando 266 marinheiros e se tornando o estopim para a guerra.",
      ...
      },
      {
        ...
        description:
          "O Congresso aprova a resolução de guerra após semanas de pressão popular e midiática, sob o pretexto de libertar Cuba.",
      ...
      },
      {
        ...
        description:
          "O tratado formaliza a independência de Cuba e cede Filipinas, Porto Rico e Guam aos EUA por US$ 20 milhões.",
      ...
      },
      {
        ...
        description:
          "Apesar da vitória sobre a Espanha, os EUA enfrentam resistência armada nas Filipinas, iniciando nova guerra não declarada.",
    ...
    financialInfo: {
      financialImpact:
        "O custo da guerra foi relativamente baixo em comparação aos ganhos territoriais dos EUA. A venda das Filipinas e o acesso comercial aos novos territórios impulsionaram a economia americana.",
      banks: [
        {
          name: "First National Bank of New York",
          country: "United States",
          owners: [
            { name: "J.P. Morgan", religion: "Episcopalian" },
            { name: "John D. Rockefeller", religion: "Baptist" },
          ],
        },
        {
          ...
          country: "Spain",
          owners: [
            { name: "Carlos María de Castro", religion: "Catholic" },
            { name: "Família Real Espanhola", religion: "Catholic" },
          ],
        },
      ],
      financiers: [
  ...
  },
  {
    ...
    propaganda: {
      sides: [
        ...
        },
        {
          ...
          mediaOutlets: ["The World", "The Sun"],
          techniques: [
      ...
      analysis:
        "Apesar de não haver propaganda oficial sobre o naufrágio em si, especula-se que a cobertura seletiva da mídia favoreceu os interesses dos apoiadores do Federal Reserve ao silenciar suspeitas e conexões com figuras influentes mortas no evento.",
    },
    theories: [
      {
    ...
    relatedNews: [
      {
        ...
        description:
          "Decisão de última hora levantou suspeitas posteriores sobre o conhecimento prévio do desastre.",
      ...
      },
      {
        ...
        description:
          "As mortes de John Jacob Astor IV, Benjamin Guggenheim e Isidor Straus foram vistas por teóricos como altamente convenientes para os apoiadores do banco central.",
      ...
      },
      {
        ...
        description:
          "A criação do Federal Reserve ocorreu em 1913, menos de dois anos após a morte de seus principais opositores.",
    ...
    financialInfo: {
      financialImpact:
        "O naufrágio do Titanic teve efeitos financeiros significativos, incluindo perdas massivas para seguradoras e mudanças na regulação marítima e financeira. Também eliminou vozes poderosas contra a centralização do sistema bancário nos EUA.",
      banks: [
        {
          name: "JP Morgan & Co.",
          country: "Estados Unidos",
  ...
  },
  {
    ...
    description:
      "Conflito global centrado na Europa entre 1914 e 1918, envolvendo as principais potências mundiais divididas entre os Aliados e as Potências Centrais. Marcou uma virada brutal na guerra moderna, com armas químicas, metralhadoras e trincheiras.",
    mediaPortrayal:
      "No início, os jornais glorificavam a guerra como dever patriótico e aventura heroica. À medida que o conflito se prolongava, surgiram imagens chocantes da vida nas trincheiras, amputados, e traumas psicológicos, afetando a percepção pública e criando ceticismo generalizado.",
    propaganda: {
      sides: [
        {
          ...
          mediaOutlets: ["The Times", "Le Petit Journal", "The New York Times"],
          techniques: [
            "Demonização do inimigo",
            "Apelos emocionais",
        ...
        },
        {
          ...
          slogans: ["Pelo Kaiser!", "Honra e dever", "Protejam o Império"],
          mediaOutlets: ["Berliner Tageblatt", "Neue Freie Presse"],
          techniques: [
      ...
      analysis:
        "A Primeira Guerra foi o auge da propaganda estatal moderna. Governos controlaram rigidamente a narrativa, criaram inimigos simbólicos e manipularam emoções patrióticas para manter o moral interno e recrutar soldados. A propaganda foi essencial para sustentar o esforço de guerra prolongado.",
    },
    theories: [
      {
        title: "Teoria da culpa alemã (Artigo 231 do Tratado de Versalhes)",
        description:
          "Sustenta que a Alemanha foi única e exclusivamente responsável pelo início da guerra, tese controversa e rejeitada por muitos historiadores modernos.",
        evidence:
          "Tratado de Versalhes, especialmente o Artigo 231; telegramas diplomáticos anteriores ao atentado em Sarajevo; corrida armamentista generalizada e alianças secretas.",
      },
      {
        title: "Banqueiros internacionais lucraram com a guerra",
        description:
          "Teorias revisionistas afirmam que a guerra foi prolongada por interesses bancários que financiavam ambos os lados e lucravam com empréstimos e reconstrução. Teorias conspiratórias afirmavam que banqueiros judeus lucravam com a guerra, fomentando o conflito para vender armas e controlar economias. Famílias como os Rothschild eram frequentemente citadas, sem provas reais.",
        evidence:
          "Registros de empréstimos da JP Morgan à Tríplice Entente; conexões entre bancos britânicos, franceses e americanos com fabricantes de armas; aumento abrupto dos lucros de indústrias bélicas entre 1915 e 1918.",
      },
      {
        title: "Guerra inevitável causada por alianças e imperialismo",
        description:
          "Sustenta que a guerra foi resultado da rivalidade imperialista, da corrida armamentista e de alianças rígidas que forçaram uma escalada irreversível após o assassinato de Francisco Ferdinando.",
        evidence:
          "Cartas diplomáticas de 1913-1914; debates parlamentares nos principais países europeus; análises de historiadores como Christopher Clark e Niall Ferguson.",
      },

      {
        title: "A Alemanha foi apunhalada pelas costas",
        description:
          "Na Alemanha, após a derrota, surgiu a narrativa da punhalada pelas costas', em que grupos nacionalistas acusavam comunistas, socialistas e judeus de terem sabotado o esforço de guerra — uma teoria que alimentou o antissemitismo nos anos seguintes e foi explorada pelos nazistas.",
        evidence:
          "Karl Helfferich, político alemão, acusou abertamente judeus e socialistas de desestabilizar a pátria.",
      },
      {
        title: "Judeus Suspeitos pelos czaristas do Império Russo",
        description:
          "No Império Russo, judeus eram vistos com suspeita por alguns setores da elite czarista, sendo ligados a movimentos revolucionários. Pogroms (massacres antijudaicos) ocorreram antes, durante e depois da guerra.",
        evidence: "",
      },
    ],
    image:
    ...
    relatedNews: [
      {
        ...
        description:
          "O herdeiro do trono austro-húngaro foi morto por nacionalistas sérvios em Sarajevo, evento que desencadeou o conflito.",
      ...
      },
      {
        ...
        description:
          "A violação da neutralidade belga leva o Reino Unido a declarar guerra à Alemanha.",
        source: "The Times",
        date: "1914-08-04",
      },
      {
        ...
        description:
          "Uma das batalhas mais sangrentas da guerra, com mais de 1 milhão de mortos e feridos.",
      ...
      },
      {
        ...
        description:
          "Acordo de paz impõe duras punições à Alemanha, incluindo reparações, perdas territoriais e aceitação da culpa pela guerra.",
    ...
    financialInfo: {
      financialImpact:
        "A guerra devastou as finanças europeias, levando à hiperinflação na Alemanha e ao endividamento massivo do Reino Unido e França com os Estados Unidos. Criou as bases para a crise econômica dos anos 1920 e 1930.",
      banks: [
        {
          name: "J.P. Morgan & Co.",
          country: "United States",
          owners: [{ name: "J.P. Morgan Jr.", religion: "Episcopalian" }],
        },
        {
          name: "Bank of England",
          country: "United Kingdom",
          owners: [
            { name: "Família Rothschild", religion: "Jewish" },
            { name: "Montagu Norman", religion: "Anglican" },
          ],
        },
        {
          name: "Deutsche Bank",
  ...
  },
  {
    ...
    description:
      "Judeus participaram ativamente da Primeira Guerra Mundial em todos os lados do conflito, enquanto também foram alvos de teorias conspiratórias que os associavam à alta finança e à manipulação da guerra.",
    mediaPortrayal:
      "A mídia da época variava entre reconhecer o esforço patriótico de soldados judeus e propagar teorias antissemitas, especialmente após a guerra, associando judeus à derrota alemã e a interesses financeiros internacionais.",
    propaganda: {
      sides: [
        {
          name: "Império Alemão",
          slogans: ["Unidade nacional", "Contra o inimigo interno"],
          mediaOutlets: ["Deutsche Zeitung", "Berliner Tageblatt"],
          techniques: ["Demonização de minorias", "Nacionalismo extremo"],
        },
        {
          name: "Império Russo",
          slogans: ["Ordem cristã", "Contra o bolchevismo"],
          mediaOutlets: ["Novoye Vremya"],
          techniques: ["Medo do comunismo", "Antissemitismo tradicional"],
        },
      ],
      analysis:
        "A propaganda frequentemente utilizava o antissemitismo como ferramenta de coesão nacional e para justificar derrotas ou dificuldades internas, vinculando judeus a teorias de conspiração financeiras ou revolucionárias.",
    },
    theories: [
      {
        title: "Banqueiros judeus lucraram com a guerra",
        description:
          "Teorias conspiratórias afirmavam que famílias como os Rothschild incentivaram o conflito para lucrar com empréstimos de guerra.",
        evidence:
          "Sem evidência concreta, amplamente desmentido por historiadores.",
      },
      {
        title: "A 'punhalada pelas costas' na Alemanha",
        description:
          "Narrativa nacionalista que culpava socialistas, judeus e comunistas pela derrota alemã em 1918.",
        evidence:
    ...
    relatedNews: [
      {
        ...
        description:
          "Altos níveis de participação e lealdade entre cidadãos judeus do Império Alemão.",
      ...
      },
      {
        ...
        description:
          "Mesmo enfrentando pogroms e restrições, centenas de milhares de judeus servem no exército russo.",
    ...
    financialInfo: {
      financialImpact:
        "Acusações infundadas sugeriam que banqueiros judeus financiavam ambos os lados da guerra.",
      banks: [
        {
          name: "Warburg Bank",
          country: "Alemanha",
          owners: [{ name: "Max Warburg", religion: "Judaísmo" }],
        },
        {
          name: "Kuhn, Loeb & Co.",
          country: "EUA",
          owners: [{ name: "Jacob Schiff", religion: "Judaísmo" }],
        },
        {
          name: "Banque Rothschild",
          country: "França",
          owners: [{ name: "Édouard de Rothschild", religion: "Judaísmo" }],
        },
      ],
      financiers: [
        {
  ...
  },
  {
    ...
    propaganda: {
      sides: [
        {
          ...
          slogans: ["Libertar a Europa", "Libertar a América do Norte"],
          mediaOutlets: ["The Times"],
          techniques: ["Culto à personalidade", "Exaltação nacionalista"],
        },
        {
      ...
      analysis:
        "A propaganda da Guerra Civil Russa foi uma tentativa de persuadir a população para apoiar o Exército Vermelho, enquanto os opositores utilizaram narrativas similares com objetivos contrários.",
    },
    theories: [
      {
        title: "A teoria da 'conspiração judaico-bolchevique'",
        description:
          "Teoria promovida por opositores dos soviéticos alegando que a revolução era parte de um complô judeu internacional, usada como instrumento de propaganda anticomunista e antissemita.",
      },
      {
        title: "Efeitos da intervenção ocidental",
        description:
          "Historiadores debatem se a intervenção de países ocidentais prolongou o conflito ou fortaleceu o apoio ao regime bolchevique ao gerar um senso de ameaça externa unificadora.",
      },
    ],
    relatedNews: [],
    financialInfo: {
      financialImpact:
        "O conflito desestabilizou completamente o sistema financeiro imperial russo, com nacionalizações forçadas e o surgimento de uma economia centralmente planejada. Houve apoio indireto estrangeiro a ambos os lados, com impacto geopolítico duradouro.",
      banks: [
        {
          name: "Bank of England",
          country: "United Kingdom",
          owners: [{ name: "Governo Britânico", religion: "Anglicano" }],
        },
        {
          name: "Banque de France",
          country: "France",
          owners: [{ name: "Governo Francês", religion: "Católico" }],
        },
      ],
      financiers: [
        {
  ...
  },
  {
    ...
    propaganda: {
      sides: [
        {
          name: "Aliados",
          slogans: ["Unidos pela liberdade", "Derrotar o Eixo"],
          mediaOutlets: ["BBC", "The New York Times"],
          techniques: ["Desumanização do inimigo", "Apelo ao patriotismo"],
        },
        {
          name: "Eixo",
          slogans: ["Nova Ordem Mundial", "Europa para os europeus"],
          mediaOutlets: ["Der Stürmer", "Il Popolo d’Italia"],
    ...
    theories: [
      {
        title:
          "Os judeus como financistas das Guerras e Responsáveis pela sofrimento da Alemanha",
        description:
          "Teorias sugerem que os judeus eram financiadores das Guerras e responsáveis pelo sofrimento da Alemanha.",
        evidence: "Os financiadores da Guerra",
      },
      {
        title: "Pearl Harbor como pretexto",
        description:
          "Teorias sugerem que Roosevelt sabia do ataque a Pearl Harbor antecipadamente e permitiu que ocorresse para justificar a entrada dos EUA na guerra.",
        evidence: "Mensagens interceptadas antes do ataque",
      },
      {
        title: "Bomba atômica como demonstração de poder",
        description:
          "Historiadores argumentam que o bombardeio do Japão visava impressionar a União Soviética mais do que encerrar a guerra.",
    ...
    relatedNews: [
      ...
      },
      {
        ...
        description:
          "A fundação das Nações Unidas em 1945 marca o esforço de reconstrução e prevenção de novos conflitos.",
        source: "BBC News",
        date: "1945-10-24",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Conflito militar entre a Coreia do Norte (apoiada pela China e URSS) e a Coreia do Sul (apoiada pelos EUA e aliados da ONU), que resultou em milhões de mortes e uma divisão permanente da península coreana.",
    mediaPortrayal:
      "No Ocidente, foi retratada como uma luta heroica contra o comunismo; já na propaganda comunista, era descrita como resistência contra o imperialismo americano.",
    propaganda: {
      sides: [
        {
          name: "Coreia do Norte e aliados",
          slogans: ["Unidade da Península", "Derrotar os imperialistas"],
          mediaOutlets: ["Rodong Sinmun", "Agência Xinhua"],
          techniques: [
            "Culto à personalidade",
        ...
        },
        {
          ...
          slogans: ["Defesa da liberdade", "Pare o comunismo"],
          mediaOutlets: ["Voice of America", "BBC"],
          techniques: [
            "Apelo à democracia",
            "Medo do comunismo",
            "Demonização do inimigo",
      ...
      analysis:
        "A propaganda de ambos os lados foi usada para justificar intervenções externas e consolidar o apoio interno, muitas vezes escondendo os verdadeiros interesses geopolíticos envolvidos.",
    },
    theories: [
      {
        title: "A guerra como proxy da Guerra Fria",
        description:
          "Teóricos argumentam que a Coreia foi usada como palco para um conflito indireto entre os EUA e a URSS.",
        evidence:
          "Documentos desclassificados do Departamento de Estado e arquivos soviéticos",
      },
      {
        title: "Teoria de instigação soviética",
        description:
          "Alguns acreditam que Stalin encorajou Kim Il-sung a invadir o sul para testar a reação americana.",
    ...
    relatedNews: [
      {
        ...
        description:
          "O Conselho de Segurança autoriza ação militar liderada pelos EUA.",
        source: "New York Times",
        date: "1950-06-27",
      },
      {
        ...
        description:
          "Conflito termina com cessar-fogo, mas sem tratado de paz definitivo.",
        source: "BBC",
        date: "1953-07-27",
      },
    ],
    financialInfo: {
      financialImpact:
        "A guerra drenou bilhões de dólares das potências envolvidas e destruiu a economia coreana.",
      banks: [
        {
          name: "Bank of Korea",
        ...
        },
        {
          ...
          country: "China",
          owners: [
            { name: "Partido Comunista Chinês", religion: "Ateísmo de Estado" },
          ],
        },
      ],
      financiers: [
  ...
  },
  {
    ...
    propaganda: {
      sides: [
        {
          name: "Estados Unidos",
          slogans: ["Liberdade para o Vietnã", "Contra o comunismo"],
          mediaOutlets: ["The New York Times", "CNN"],
          techniques: ["Apelo ao patriotismo", "Demonização do Vietcong"],
        },
        {
          name: "Vietcong",
          slogans: ["Libertação nacional", "Contra a agressão imperialista"],
          mediaOutlets: ["Rádio Hanoi"],
          techniques: [
      ...
      analysis:
        "A propaganda americana focou no combate ao comunismo, enquanto o Vietcong enfatizou a luta pela independência nacional.",
    },
    theories: [
      {
    ...
    relatedNews: [
      {
        ...
        description:
          "O massacre de civis vietnamitas por tropas americanas em My Lai expôs a brutalidade da guerra.",
      ...
      },
      {
        ...
        description:
          "Grandes protestos contra a guerra ocorreram em várias cidades americanas, culminando no massacre de Kent State.",
    ...
    financialInfo: {
      financialImpact:
        "A guerra teve um impacto financeiro significativo nos EUA, contribuindo para a crise econômica dos anos 1970.",
      banks: [
        {
          name: "Bank of America",
          country: "Estados Unidos",
          owners: [{ name: "A.P. Giannini", religion: "Católico" }],
        },
        {
          name: "Chase Manhattan Bank",
          country: "Estados Unidos",
          owners: [{ name: "David Rockefeller", religion: "Protestante" }],
        },
      ],
      financiers: [
        {
  ...
  },
  {
    ...
    propaganda: {
      sides: [
        {
          name: "União Soviética",
          slogans: ["Proteção da revolução", "Estabilidade regional"],
          mediaOutlets: ["Pravda"],
          techniques: [
        ...
        {
          name: "Mujahideen",
          slogans: ["Jihad contra os infiéis", "Liberdade para o Afeganistão"],
          mediaOutlets: ["Rádio Kabul"],
          techniques: ["Apelo à religião", "Medo da ocupação estrangeira"],
        },
      ],
      analysis:
        "A propaganda soviética enfatizava a proteção da revolução, enquanto os mujahideen usavam o apelo religioso para mobilizar apoio.",
    },
    theories: [
      {
        title: "Armadilha Afegã",
        description:
          "Os EUA deliberadamente encorajaram a URSS a invadir o Afeganistão para criar seu próprio 'Vietnã'.",
        evidence: "Documentos desclassificados da CIA",
      },
      {
        title: "Colapso da URSS",
        description:
          "A guerra acelerou o colapso da União Soviética devido ao custo financeiro e político.",
    ...
    relatedNews: [
      {
        ...
        description:
          "Os EUA começaram a fornecer armas e treinamento aos mujahideen através da Operação Ciclone.",
        source: "The Washington Post",
        date: "1980-01-15",
      },
      {
        ...
        description:
          "As últimas tropas soviéticas deixaram o Afeganistão após nove anos de conflito.",
        source: "BBC News",
        date: "1989-02-15",
      },
    ],
    financialInfo: {
      financialImpact:
        "A guerra teve um impacto financeiro devastador na União Soviética, contribuindo para sua crise econômica.",
      banks: [
        {
          name: "Gosbank",
          country: "União Soviética",
          owners: [{ name: "Nikolai Bulganin", religion: "Ateísmo de Estado" }],
        },
        {
          name: "Bank of America",
          country: "Estados Unidos",
  ...
  },
  {
    ...
    propaganda: {
      sides: [
        {
          ...
          slogans: ["Liberdade para o Kuwait", "Contra a agressão iraquiana"],
          mediaOutlets: ["CNN", "BBC"],
          techniques: [
        ...
        {
          name: "Iraque",
          slogans: ["Defesa da soberania", "Contra o imperialismo ocidental"],
          mediaOutlets: ["Al Jazeera"],
          techniques: [
            "Apelo ao nacionalismo",
            "Medo da dominação estrangeira",
          ],
      ...
      analysis:
        "A propaganda da coalizão focou na defesa da soberania do Kuwait, enquanto o Iraque tentou retratar o conflito como uma luta contra o imperialismo ocidental.",
    },
    theories: [
      {
        title: "Teoria do Bebê Incubadora",
        description:
          "Um relato fabricado sobre soldados iraquianos matando bebês em incubadoras no Kuwait foi usado para ganhar apoio público para a guerra.",
        evidence: "Testemunhos posteriormente desmentidos",
      },
      {
        title: "Armadilha Diplomática",
        description:
          "Os EUA enganaram Saddam Hussein, sugerindo que não interviriam se ele invadisse o Kuwait.",
    ...
    relatedNews: [
      {
        ...
        description:
          "A coalizão internacional inicia a operação militar para libertar o Kuwait.",
        source: "CNN",
        date: "1991-01-17",
      },
      {
        ...
        description:
          "As forças iraquianas retiram-se do Kuwait após intensos bombardeios.",
        source: "BBC",
        date: "1991-02-28",
      },
    ],
    financialInfo: {
      financialImpact:
        "A guerra teve um impacto financeiro significativo, especialmente para o Iraque, que enfrentou sanções econômicas prolongadas.",
      banks: [
        {
        ...
        },
        {
          ...
          country: "Iraque",
          owners: [{ name: "Saddam Hussein", religion: "Islâmico" }],
        },
      ],
      financiers: [
        {
  ...
  },
  {
    ...
    propaganda: {
      sides: [
        {
          name: "Sérvia",
          slogans: ["Defesa da Iugoslávia", "Proteção dos sérvios"],
          mediaOutlets: ["Politika"],
          techniques: ["Apelo ao nacionalismo", "Medo da desintegração"],
        },
        {
          name: "Croácia",
          slogans: ["Independência e liberdade", "Defesa da identidade croata"],
          mediaOutlets: ["Večernji list"],
          techniques: ["Apelo à autodeterminação", "Demonização dos sérvios"],
        },
      ],
      analysis:
        "A propaganda foi usada para justificar as ações de ambos os lados, com narrativas que frequentemente exageravam ou distorciam os fatos.",
    },
    theories: [
      {
        title: "Conspiração Ocidental",
        description:
          "Potências ocidentais deliberadamente encorajaram a desintegração da Iugoslávia para enfraquecer um estado socialista independente.",
      },
      {
    ...
    relatedNews: [
      {
        ...
        description:
          "O massacre de mais de 8.000 homens e meninos bósnios em Srebrenica é considerado o pior massacre na Europa desde a Segunda Guerra Mundial.",
        source: "BBC News",
        date: "1995-07-11",
      },
      {
        ...
        description:
          "O Acordo de Dayton, assinado em 1995, põe fim à guerra na Bósnia e estabelece uma nova estrutura política para a região.",
        source: "The New York Times",
        date: "1995-12-14",
      },
    ],
    financialInfo: {
      financialImpact:
        "A guerra teve um impacto financeiro devastador na região, com infraestrutura destruída e economias em colapso.",
      banks: [
        {
          name: "Banco Nacional da Sérvia",
          country: "Sérvia",
          owners: [{ name: "Slobodan Milošević", religion: "Ortodoxo" }],
        },
        {
          name: "Banco Nacional da Croácia",
          country: "Croácia",
          owners: [{ name: "Franjo Tuđman", religion: "Católico" }],
        },
      ],
      financiers: [
        {
  ...
  },
  {
    ...
    propaganda: {
      sides: [
        {
          name: "Estados Unidos",
          slogans: ["Liberdade e Segurança", "Contra o terrorismo"],
          mediaOutlets: ["CNN", "Fox News"],
          techniques: ["Medo do terrorismo", "Apelo ao patriotismo"],
        },
        {
          name: "Al-Qaeda",
          slogans: ["Jihad contra os EUA", "Defesa do Islã"],
          mediaOutlets: ["Al Jazeera"],
          techniques: ["Apelo à religião", "Demonização dos EUA"],
        },
      ],
      analysis:
        "A propaganda americana focou na defesa da liberdade e segurança, enquanto a Al-Qaeda usou o apelo religioso para justificar suas ações.",
    },
    theories: [
      {
        title: "Teorias da Conspiração sobre o 11 de Setembro",
        description:
          "Teorias sugerem envolvimento ou conhecimento prévio do governo dos EUA, embora refutadas por evidências.",
    ...
    relatedNews: [
      {
        title: "Ataques de 11 de Setembro",
        description:
          "Os ataques terroristas de 11 de setembro de 2001 resultaram na morte de quase 3.000 pessoas.",
        source: "The New York Times",
        date: "2001-09-11",
      },
      {
        ...
        description:
          "Os EUA invadiram o Afeganistão em outubro de 2001 para derrubar o regime Talibã.",
        source: "BBC News",
        date: "2001-10-07",
      },
    ],
    financialInfo: {
      financialImpact:
        "A guerra teve um impacto financeiro significativo, com custos estimados em trilhões de dólares.",
      banks: [
        {
          name: "Federal Reserve",
          country: "Estados Unidos",
  ...
  },
  {
      ...
      sides: [
        {
          ...
          slogans: ["Estabilidade e segurança", "Contra o caos"],
          mediaOutlets: ["Al Arabiya"],
          techniques: ["Medo da instabilidade", "Apelo à ordem"],
        },
        {
          name: "Manifestantes",
          slogans: ["Liberdade e dignidade", "O povo quer a queda do regime"],
          mediaOutlets: ["Al Jazeera"],
          techniques: ["Apelo à justiça social", "Demonização dos regimes"],
        },
      ],
      analysis:
        "A propaganda dos governos enfatizava a estabilidade, enquanto os manifestantes usavam o apelo à liberdade e justiça social.",
    },
    theories: [
      {
        title: "Conspiração Ocidental",
      ...
      },
      {
        ...
        description:
          "Outros argumentam que redes sociais como Twitter e Facebook foram instrumentais em facilitar os protestos.",
      },
    ],
    ...
    relatedNews: [
      {
        ...
        description:
          "O ato de protesto de Mohamed Bouazizi em Túnis desencadeou a onda de protestos na região.",
        source: "BBC News",
        date: "2010-12-17",
      },
      {
        ...
        description:
          "Após 18 dias de protestos, Hosni Mubarak renuncia à presidência do Egito.",
        source: "Al Jazeera",
        date: "2011-02-11",
      },
    ],
    financialInfo: {
      financialImpact:
        "Os conflitos tiveram um impacto financeiro devastador na região, com economias em colapso e infraestrutura destruída.",
      banks: [
        {
          name: "Banco Central do Egito",
          country: "Egito",
          owners: [{ name: "Farouk El-Okdah", religion: "Islâmico" }],
        },
        {
          name: "Banco Central da Tunísia",
          country: "Tunísia",
          owners: [{ name: "Mustapha Kamel Nabli", religion: "Islâmico" }],
        },
      ],
      financiers: [
        {
  ...
  },
  {
    ...
    propaganda: {
      sides: [
        {
          ...
          mediaOutlets: ["BBC", "CNN", "Deutsche Welle"],
          techniques: [
      ...
      analysis:
        "A propaganda de ambos os lados do conflito molda profundamente a percepção global, utilizando tecnologia, redes sociais e agências de notícias para influenciar a narrativa internacional.",
    },
    theories: [
      {
        title: "Expansão da OTAN como catalisador",
        description:
          "Narrativas competitivas sobre as origens do conflito incluem teorias sobre a ameaça percebida pela Rússia em relação à expansão da OTAN até suas fronteiras.",
      },
      {
        title: "Influência dos oligarcas",
        description:
          "Teorias sobre o papel dos oligarcas ucranianos e russos no financiamento, direcionamento e desestabilização do conflito em benefício próprio.",
      },
      {
        title: "Mortes misteriosas de oligarcas",
        description:
          "Diversas mortes suspeitas de oligarcas russos desde o início do conflito levantaram especulações sobre queima de arquivos ou disputas internas.",
      },
      {
        title: "Interferência ocidental em 2014",
        description:
          "Teorias sugerem envolvimento ativo de potências ocidentais na mudança de regime em 2014, particularmente no apoio aos protestos de Maidan e na destituição de Yanukovych.",
      },
    ],
    relatedNews: [
      {
        ...
        description:
          "Desde 2022, uma série de mortes envolvendo executivos de empresas de energia russas levanta suspeitas sobre motivações políticas ou econômicas.",
        source: "Reuters",
        date: "2022-12-15",
      },
      {
        ...
        description:
          "Após a invasão, o governo ucraniano consolidou o controle de ativos energéticos estratégicos com apoio de entidades internacionais.",
        source: "Ukrinform",
        date: "2023-04-05",
      },
      {
        ...
        description:
          "As sanções lideradas pelos EUA e UE levaram ao isolamento de bancos russos do sistema SWIFT e a uma reestruturação do sistema financeiro do país.",
    ...
    financialInfo: {
      financialImpact:
        "O conflito causou abalos no mercado energético global, levou a reestruturações financeiras na Rússia e à dependência crescente da Ucrânia por ajuda internacional.",
      banks: [
        {
          name: "Sberbank",
          country: "Rússia",
  ...
  },
  {
    ...
    propaganda: {
      sides: [
        {
          ...
          mediaOutlets: ["The Guardian", "New York Times", "Wired"],
          techniques: [
        ...
        },
        {
          ...
          slogans: ["Soberania Digital", "IA pelo progresso soberano"],
          mediaOutlets: ["Global Times", "Sputnik Tech"],
          techniques: [
      ...
      analysis:
        "A propaganda em conflitos híbridos envolve IA na produção e disseminação de narrativas, manipulação de redes sociais e criação de conteúdos falsificados (deep fakes), dificultando a distinção entre realidade e ficção.",
    },
    theories: [
      {
        title: "Desenvolvimento secreto de IAs militares autônomas",
        description:
          "Relatos indicam que nações e corporações privadas desenvolveram inteligências artificiais capazes de operar de forma independente em teatros de guerra.",
      },
      {
        title: "Manipulação de mercados por IAs",
        description:
          "Especulações sobre IA sendo usada para criar instabilidade econômica ou manipular algoritmos financeiros globais para benefício estratégico.",
      },
      {
        title: "Uso de deep fakes em desestabilização global",
        description:
          "Teorias sugerem que deep fakes estão sendo utilizados por diversos atores para sabotar reputações, eleições e confiança pública em larga escala.",
      },
    ],
    relatedNews: [
      {
        ...
        description:
          "Uma falha de segurança em 2024 expôs vulnerabilidades em sistemas militares interconectados via IA.",
      ...
      },
      {
        ...
        description:
          "Relatórios emergem sobre uso de drones e sistemas ofensivos guiados por IA sem controle direto de operadores humanos.",
        source: "DefenseTech",
        date: "2025-01-20",
      },
      {
        ...
        description:
          "Investigações revelam fluxos de criptomoedas sendo usados por atores estatais e privados para financiar ciberataques e operações de influência.",
    ...
    financialInfo: {
      financialImpact:
        "O uso de IA e criptomoedas transformou o financiamento de guerras, possibilitando operações secretas, anonimato e fluxos financeiros descentralizados.",
      banks: [
        {
